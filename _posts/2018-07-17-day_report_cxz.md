...
1. 培训体系建设：(课程、认证、数据收集)（卢）
    ...
    2.React课程建设：根据向导生成新的前后端项目，问题调试解决，调整文档、环境、案例代码，准备下周培训；
...
6. 其他
    ...
    2.云官网-产品页面修改（已完成12个），最新动态、最新动态详情页面搭建（样式布局已完成，请求交互未完成） （孙超）；
    
    3.云官网-培训认证页面改版（未完成），解决专属云测试提出的两个bug（wangjch）
