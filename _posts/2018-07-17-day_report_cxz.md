...
6. 其他
    ...
    2.配合UE应用平台样式优化，功能调整；
 7.分公司现场培训及实施问题进度跟进 （李海）
    1.学习MDM产品架构，对重点功能进行实例练习
    2.明泰铝业现场培训-MDM
    3、协调产品部，处理全友大数据问题，进行中
...
6、主数据的学习资料多、内容杂，简单掌握容易，细节和贴近实战的功能还需要不断落实到代码，后期可以针对每个教学点定义标准培训内容，减少重复工作（李）
...
7.继续跟进全友问题,争取下周解决；学习MDM其他功能配置；整理张毫留下的视频；学习ESB培训内容-李
