...
6. 其他
    ...
    1.云官网-产品页面修改还有2个页面未修改（设计图没完成），最新动态、最新动态详情页面搭建完成，首页修改完成 （孙超）；

    2.专属云应用平台--解决部分测试中出现分配的bug(wangjch)；

二、工作总结及感想：(回顾工作情况，分析工作中的问题及改进建议、个人未来一周get新技术)【每人至少填写一条+加名字】(艾)

1. 友云采界面词条截断，一句话分成两条的情况较多，翻译时不好判断，只能后期界面验证时确定-艾；
2. 本周主要完成培训以及模板打印功能、参照功能的支持；针对培训中的部门问题，后续可以通过优化模板代码-刘；
3. 培训中比统一培训时间合理，课程内容优化，明显效果比之前要好。问题是练习还是不明确，下周回顾改进课程-卢；
4. 本周熟悉react培训流程，前后端对接以及新向导开发等，后续还需要跟进课程优化等内容-于；
5. 本周react培训，培训效果还在于对案例的梳理、文档产出，学员依据相关资料才会更清晰-宋；
6. 参与react培训，整理云官网代码目录结构和文件-孙超；
7. 在解决测试问题的过程中，逐渐熟悉页面功能和代码逻辑-wangjch

三、下周计划：(未完成工作、计划下周新开始的工作)【每人至少填写一条+加名字】(车)

1. 云产品国际化英文界面审校，伙伴培训教务工作-艾；
2. React课程问题改进，模式调整优化，结合向导开发调整-卢；
3. 模板代码优化、找机会参与组件开发工作-刘志鹏；
4. react培训内容的进一步的学习总结-于；
5. 高端BG伙伴移动培训相关事宜-宋慧慧；
6. 产品页面剩余工作，服务与支持相关页面修改--孙超；
7.解决剩余分配专属云应用平台bug--wangjch
